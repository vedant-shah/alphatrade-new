...
export const Cover = ({ children, className }) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className="relative hover:bg-transparent  group/cover inline-block dark:bg-neutral-900 bg-transparent hover:text-white text-white px-2 py-2  transition duration-200 rounded-sm">
      <AnimatePresence>
        {hovered && (
          <motion.div
            initial={{ opacity: 0 }}
