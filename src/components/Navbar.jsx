...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b bg-black/70 backdrop-blur-md border-neutral-800">
      <div className="max-w-6xl px-6 mx-auto">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="text-xl font-bold text-white">
            <a
              ...
              href="/"
              aria-current="page"
              class="navbar_brand w-inline-block w--current">
              <svg
          ...
          <div className="items-center hidden space-x-8 md:flex">
            ...
            <Link
              to="/demo"
              className="bg-[#8a41e7] text-white px-4 py-2 rounded-lg hover:bg-[#8a41e7]/80 transition-colors">
              Book a Demo
            </Link>
          </div>
        ...
        {/* Mobile Nav Menu */}
        {isMenuOpen && (
          <div className="pt-2 pb-4 border-t md:hidden border-neutral-800">
            <div className="flex flex-col space-y-4">
              ...
              <Link
                to="/demo"
                className="bg-[#8a41e7] text-white px-4 py-2 rounded-lg hover:bg-[#8a41e7]/80 transition-colors inline-block"
                onClick={() => setIsMenuOpen(false)}>
                Book a Demo
              </Link>
            </div>
